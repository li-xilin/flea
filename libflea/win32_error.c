...
static struct win32_error {
	...
	{ 6020, "ERROR_CS_ENCRYPTION_NEW_ENCRYPTED_FILE", "A new encrypted file is being created and a  needs to be provided." },
	...
	{ 6826, "ERROR_TXF_DIR_NOT_EMPTY", "The  directory must be empty for this operation to succeed." },
	...
	{ 8644, "ERROR_DOMAIN_SID_SAME_AS_LOCAL_WORKSTATION", "The domain join cannot be completed because the SID of the domain you attempted to join was identical to the SID of this machine. This is a symptom of an improperly cloned operating system install. You should run sysprep on this machine in order to generate a new machine SID. Please see https://go.microsoft.com/fwlink/p/?linkid=168895 for more information." },
	...
	{ 9103, "DNS_ERROR_NSEC3_INCOMPATIBLE_WITH_RSA_SHA1", "NSEC3 is not compatible with the RSA-SHA-1 algorithm. Choose a different algorithm or use NSEC." },
	...
	{ 12178, "ERROR_WINHTTP_AUTO_PROXY_SERVICE_ERROR", "Returned by WinHttpGetProxyForUrl when a proxy for the specified URL cannot be located." },
	{ 12180, "ERROR_WINHTTP_AUTODETECTION_FAILED", "Returned by WinHttpDetectAutoProxyConfigUrl if WinHTTP was unable to discover the URL of the Proxy Auto-Configuration (PAC) file." },
	{ 12166, "ERROR_WINHTTP_BAD_AUTO_PROXY_SCRIPT", "An error occurred executing the script code in the Proxy Auto-Configuration (PAC) file." },
	{ 12103, "ERROR_WINHTTP_CANNOT_CALL_AFTER_OPEN", "Returned by the HttpRequest object if a specified option cannot be requested after the Open method has been called." },
	{ 12102, "ERROR_WINHTTP_CANNOT_CALL_AFTER_SEND", "Returned by the HttpRequest object if a requested operation cannot be performed after calling the Send method." },
	{ 12100, "ERROR_WINHTTP_CANNOT_CALL_BEFORE_OPEN", "Returned by the HttpRequest object if a requested operation cannot be performed before calling the Open method." },
	{ 12101, "ERROR_WINHTTP_CANNOT_CALL_BEFORE_SEND", "Returned by the HttpRequest object if a requested operation cannot be performed before calling the Send method." },
	{ 12029, "ERROR_WINHTTP_CANNOT_CONNECT", "Returned if connection to the server failed." },
	{ 12183, "ERROR_WINHTTP_CHUNKED_ENCODING_HEADER_SIZE_OVERFLOW", "Returned by WinHttpReceiveResponse when an overflow condition is encountered in the course of parsing chunked encoding." },
	{ 12044, "ERROR_WINHTTP_CLIENT_AUTH_CERT_NEEDED", "Returned by WinHttpReceiveResponse when the server requests client authentication. Windows Server 2003 with SP1 and Windows XP with SP2: This error is not supported." },
	{ 12030, "ERROR_WINHTTP_CONNECTION_ERROR", "The connection with the server has been reset or terminated, or an incompatible SSL protocol was encountered. For example, WinHTTP version 5.1 does not support SSL2 unless the client specifically enables it." },
	{ 12155, "ERROR_WINHTTP_HEADER_ALREADY_EXISTS", "Obsolete; no longer used." },
	{ 12181, "ERROR_WINHTTP_HEADER_COUNT_EXCEEDED", "Returned by WinHttpReceiveResponse when a larger number of headers were present in a response than WinHTTP could receive." },
	{ 12150, "ERROR_WINHTTP_HEADER_NOT_FOUND", "The requested header cannot be located." },
	{ 12182, "ERROR_WINHTTP_HEADER_SIZE_OVERFLOW", "Returned by WinHttpReceiveResponse when the size of headers received exceeds the limit for the request handle." },
	{ 12019, "ERROR_WINHTTP_INCORRECT_HANDLE_STATE", "The requested operation cannot be carried out because the handle supplied is not in the correct state." },
	{ 12018, "ERROR_WINHTTP_INCORRECT_HANDLE_TYPE", "The type of handle supplied is incorrect for this operation." },
	{ 12004, "ERROR_WINHTTP_INTERNAL_ERROR", "An internal error has occurred." },
	{ 12009, "ERROR_WINHTTP_INVALID_OPTION", "A request to WinHttpQueryOption or WinHttpSetOption specified an invalid option value." },
	{ 12154, "ERROR_WINHTTP_INVALID_QUERY_REQUEST", "Obsolete; no longer used." },
	{ 12152, "ERROR_WINHTTP_INVALID_SERVER_RESPONSE", "The server response cannot be parsed." },
	{ 12005, "ERROR_WINHTTP_INVALID_URL", "The URL is not valid." },
	{ 12015, "ERROR_WINHTTP_LOGIN_FAILURE", "The login attempt failed. When this error is encountered, the request handle should be closed with WinHttpCloseHandle. A new request handle must be created before retrying the function that originally produced this error." },
	{ 12007, "ERROR_WINHTTP_NAME_NOT_RESOLVED", "The server name cannot be resolved." },
	{ 12172, "ERROR_WINHTTP_NOT_INITIALIZED", "Obsolete; no longer used." },
	{ 12017, "ERROR_WINHTTP_OPERATION_CANCELLED", "The operation was canceled, usually because the handle on which the request was operating was closed before the operation completed." },
	{ 12011, "ERROR_WINHTTP_OPTION_NOT_SETTABLE", "The requested option cannot be set, only queried." },
	{ 12001, "ERROR_WINHTTP_OUT_OF_HANDLES", "Obsolete; no longer used." },
	{ 12156, "ERROR_WINHTTP_REDIRECT_FAILED", "The redirection failed because either the scheme changed or all attempts made to redirect failed (default is five attempts)." },
	{ 12032, "ERROR_WINHTTP_RESEND_REQUEST", "The WinHTTP function failed. The desired function can be retried on the same request handle." },
	{ 12184, "ERROR_WINHTTP_RESPONSE_DRAIN_OVERFLOW", "Returned when an incoming response exceeds an internal WinHTTP size limit." },
	{ 12177, "ERROR_WINHTTP_SCRIPT_EXECUTION_ERROR", "An error was encountered while executing a script." },
	{ 12038, "ERROR_WINHTTP_SECURE_CERT_CN_INVALID", "Returned when a certificate CN name does not match the passed value (equivalent to a CERT_E_CN_NO_MATCH error)." },
	...
	{ 12057, "ERROR_WINHTTP_SECURE_CERT_REV_FAILED", "Indicates that revocation cannot be checked because the revocation server was offline (equivalent to CRYPT_E_REVOCATION_OFFLINE)." },
	{ 12170, "ERROR_WINHTTP_SECURE_CERT_REVOKED", "Indicates that a certificate has been revoked (equivalent to CRYPT_E_REVOKED)." },
	{ 12179, "ERROR_WINHTTP_SECURE_CERT_WRONG_USAGE", "Indicates that a certificate is not valid for the requested usage (equivalent to CERT_E_WRONG_USAGE)." },
	{ 12157, "ERROR_WINHTTP_SECURE_CHANNEL_ERROR", "Indicates that an error occurred having to do with a secure channel (equivalent to error codes that begin with 'SEC_E_' and 'SEC_I_' listed in the 'winerror.h' header file)." },
	...
	{ 12045, "ERROR_WINHTTP_SECURE_INVALID_CA", "Indicates that a certificate chain was processed, but terminated in a root certificate that is not trusted by the trust provider (equivalent to CERT_E_UNTRUSTEDROOT)." },
	{ 12169, "ERROR_WINHTTP_SECURE_INVALID_CERT", "Indicates that a certificate is invalid (equivalent to errors such as CERT_E_ROLE, CERT_E_PATHLENCONST, CERT_E_CRITICAL, CERT_E_PURPOSE, CERT_E_ISSUERCHAINING, CERT_E_MALFORMED and CERT_E_CHAINING)." },
	{ 12012, "ERROR_WINHTTP_SHUTDOWN", "The WinHTTP function support is being shut down or unloaded." },
	{ 12002, "ERROR_WINHTTP_TIMEOUT", "The request has timed out.  This error can be returned as a result of TCP/IP time-out behavior, regardless of time-out values set in Windows HTTP Services." },
	{ 12167, "ERROR_WINHTTP_UNABLE_TO_DOWNLOAD_SCRIPT", "The PAC file cannot be downloaded. For example, the server referenced by the PAC URL may not have been reachable, or the server returned a 404 NOT FOUND response." },
	{ 12176, "ERROR_WINHTTP_UNHANDLED_SCRIPT_TYPE", "The script type is not supported." },
	{ 12006, "ERROR_WINHTTP_UNRECOGNIZED_SCHEME", "The URL specified a scheme other than 'http:' or 'https:'." },
	...
	{ 15325, "ERROR_GPIO_OPERATION_DENIED", "The requested operation is not supported for the specified handle." },
...
// static ax_rb_r g_error_map = AX_R_NULL;

const char *flea_win32_strerror(unsigned int nr)
{
	for (int i = 0; g_win32_error_table[i].brief; i++) {
		if (g_win32_error_table[i].nr == nr)
			return g_win32_error_table[i].desc;
	}
...
void flea_perror(unsigned int nr)
{
	if (nr > 60000)
		...
		fprintf(stderr, "%s: error %d, %s\n", flea_module_name(), nr, flea_win32_strerror(nr));
}
